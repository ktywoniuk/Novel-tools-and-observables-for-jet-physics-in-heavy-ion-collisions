...
\begin{figure}[th]
\centering
\includegraphics[width=0.33\textwidth]{figures/SDGen/MgCompModelsBeta00Z01.pdf}%
\includegraphics[width=0.33\textwidth]{figures/SDGen/MgCompModelsBeta15Z05.pdf}%
\includegraphics[width=0.33\textwidth]{figures/SDGen/MgCompModelsBetam1Z01.pdf}%
\caption{Groomed jet mass, $M_{\mathrm{g}}$, for three different grooming settings in simulations with and without jet quenching. The uppers panels show the $M_{\mathrm{g}}$ distribution normalized by the total number of ungroomed jets while the lower panels show the ratio of JEWEL and QPYTHIA with respect to PYTHIA8.}
\label{fig:SDGenMg}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
