...
\caption{The three grooming settings studied in this report, see text for details. Shaded areas correspond to configuration that are groomed away. \kmt{Replace $z_c$ with $z_\text{cut}$.}}
\label{fig:TheorySD}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
