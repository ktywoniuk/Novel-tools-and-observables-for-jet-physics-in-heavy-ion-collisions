...
More importantly, all results in this section have been computed by embedding the MC jet samples into a centrality-dependent heavy-ion background \cite{deBarros:2012ws}, for details see \autoref{sec:uncorrelatedbackground}. Therefore, these result reflect more realistically the magnitude of effects that should be expected to arise in heavy-ion collisions at the LHC.
