...
\beq
\label{eq:RAA}
R_{AA} = \frac{\dd N_{AA}/\dd \pT^2 \dd y}{\langle T_{AA} \rangle \dd N_{pp}/\dd \pT^2 \dd y} \,,
\eeq
where
% $\langle N_\text{coll} \rangle$ counts the number of nucleon-nucleon collisions in a given centrality range,
